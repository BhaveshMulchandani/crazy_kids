...
const navItems = [
  ...
  { label: "Cafe POS", icon: Coffee },
  { label: "Cafe Menu", icon: UtensilsCrossed },
      ...
      <nav className="flex-1 px-3 py-4 space-y-1">
        {navItems.map((item) => {
          ...
          return (
            <button
              key={item.label}
              className="flex w-full items-center gap-3 rounded-xl px-3 py-3 text-sm font-medium text-white/70 transition hover:bg-white/10 hover:text-white"
            >
